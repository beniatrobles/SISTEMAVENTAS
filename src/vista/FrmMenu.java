...
public class FrmMenu extends JFrame implements ActionListener {
	...
	public FrmMenu() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrmMenu.class.getResource("/img/ventas.png")));
		...
		mntmNuevaVenta = new JMenuItem("Nueva Venta", new ImageIcon(FrmMenu.class.getResource("/img/anadir.png")));
		mntmNuevaVenta.addActionListener(this);
		...
		mntmReportesClientes.addActionListener(this);
		...
		mntmReportesCategorias.addActionListener(this);
		...
		mntmReportesVentas.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == mntmReportesClientes) {
		...
		if (e.getSource() == mntmReportesCategorias) {
			Reportes reporte = new Reportes();
		...
		if(e.getSource() == mntmReportesVentas) {
